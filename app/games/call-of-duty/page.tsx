...
export default function CallOfDutyPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!cleanUserId) {
      setError("Introduzca su ID de usuario de Activision.");
      return;
    }

    if (cleanUserId.length < 4) {
      setError("El ID de usuario debe tener al menos 4 números.");
      return;
    }
    ...
    try {
      ...
      const response = await fetch("/api/topups/call-of-duty", {
        method: "POST",
        headers: {
    ...
    <main className="game-service-page call-of-duty-page">
      ...
      >
        <span className="offers-toggle-text">
          {showOffers ? "OCULTAR OFERTAS" : "PRESIONE PARA VER OFERTAS"}
        </span>

        <span className="offers-toggle-pencil">✎</span>
      </button>
      ...
      {showOffers && (
        <section className="offers-section">
          <div className="offers-heading">
            ...
            <small>CALL OF DUTY MOBILE · ACTIVISION EE. UU.</small>
          </div>
            ...
            {offers.map((offer) => (
              ...
              >
                <div className="offer-left">
                  <div className="diamond-icon">{offer.icon}</div>
        ...
        <section id="order-section" className="order-section">
          ...
          <div className="game-note game-note-order">
            ...
            <div className="game-note-content">
              ...
              <p>
                Verifique que su cuenta de Activision pertenece a la
                región de Estados Unidos. Esta oferta no corresponde a
          ...
          <form className="order-form" onSubmit={handleSubmit}>
            ...
            <p className="player-id-description">
              Introduzca el ID de usuario de Activision donde desea
              recibir los CP.
            </p>
      ...
      {orderCreated && (
        ...
        >
          ...
          <p>
            Su orden ha sido creada correctamente y está siendo
            procesada.
          </p>
          ...
          <div className="success-order-number">
            <span>ESTADO</span>
            <strong>{orderStatus || "PENDIENTE"}</strong>
          </div>
      ...
      <footer className="game-service-footer">
        ...
        <span>CALL OF DUTY MOBILE · ACTIVISION</span>
      </footer>
    </main>
  );
  }
