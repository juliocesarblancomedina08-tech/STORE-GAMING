...
const offers: GiftCardOffer[] = [
  { id: 1, amount: "1 USD", price: 1.09 },
  { id: 2, amount: "2 USD", price: 2.02 },
  { id: 3, amount: "5 USD", price: 4.83 },
  { id: 4, amount: "10 USD", price: 9.52 },
  { id: 5, amount: "20 USD", price: 18.89 },
  { id: 6, amount: "25 USD", price: 24.32 },
  { id: 7, amount: "50 USD", price: 46.71 },
  { id: 8, amount: "100 USD", price: 94.29 },
  { id: 9, amount: "200 USD", price: 188.42 },
  { id: 10, amount: "300 USD", price: 282.56 },
  { id: 11, amount: "400 USD", price: 376.69 },
  { id: 12, amount: "500 USD", price: 470.83 },
];

const note =
  "Región: EE. UU. Tarjetas de regalo Razer Gold. Los códigos se pueden guardar de forma segura y canjear posteriormente.";

export default function RazerGoldUSA() {
  ...
  return (
    <main className="game-service-page">
      ...
      <section className="game-service-content">
        <img
          src="/images/gift-cards/gift-razer-gold-eeuu.jpg"
          alt="Razer Gold EE.UU"
        ...
        <section className="game-note">
          ...
          <div className="game-note-content">
            ...
            <div className="game-note-order">
              <span>✓</span>
              <span>
                El código se entrega después de confirmar el
                pedido.
              </span>
            </div>
          </div>
