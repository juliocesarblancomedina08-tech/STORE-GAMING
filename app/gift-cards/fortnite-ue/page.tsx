...
const note =
  "Región: UE. Tarjetas de regalo de Fortnite (códigos de V-Bucks). Los códigos se pueden guardar de forma segura y canjear más adelante.";

export default function FortniteUEGiftCardPage() {
    ...
    <main className="game-service-page">
      ...
      <section className="game-service-content">
        ...
        <div className="free-fire-main-image">
          <img
            src="/images/gift-cards/gift-fortnite-ue.jpg"
            alt="Fortnite UE"
          />
        </div>
      ...
      <footer className="game-service-footer">
        ...
        <span>
          Tarjetas de regalo Fortnite UE
        </span>
      </footer>
    </main>
  );
