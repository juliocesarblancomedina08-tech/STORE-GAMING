...
const note =
  "Región: AE. Tarjetas de regalo de Fortnite (códigos de V-Bucks). Los códigos se pueden guardar de forma segura y canjear posteriormente.";

export default function FortniteAEGiftCardPage() {
  ...
  const createOrder = () => {
    ...
    const newOrder = {
      ...
      type: "GIFT CARD",
      game: "FORTNITE (AE)",
      product: `${selectedOffer.amount} AED`,
    ...
    setTimeout(() => {
      document
        .getElementById("gift-card-success-section")
        ?.scrollIntoView({
          behavior: "smooth",
          block: "start",
        });
    ...
    <main className="game-service-page">
      ...
      <section className="game-service-content">
        <div className="free-fire-main-image">
          <img
            src="/images/gift-cards/gift-fortnite-ae.jpg"
            alt="Fortnite AE"
          />
        </div>
              ...
              {offers.map((offer) => (
                ...
                >
                  <div className="offer-info">
                    ...
                    <div>
                      <strong>{offer.amount} AED</strong>
          ...
          >
            ...
            <div className="selected-order-card">
              ...
              <div className="selected-order-product">
                <div>
                  <strong>{selectedOffer.amount} AED</strong>
                  <span>FORTNITE (AE)</span>
                </div>
              ...
              {!showConfirmation ? (
                ...
                <section className="confirmation-section">
                  <div className="confirmation-card">
                    ...
                    <p>
                      Al confirmar, tu pedido será creado y
                      quedará disponible en la sección de pedidos.
                    </p>
        ...
        {orderCreated && (
          ...
          >
            ...
            <p>
              Tu pedido de tarjeta de regalo de Fortnite fue
      ...
      <footer className="game-service-footer">
        ...
        <small>Tarjetas de regalo digitales</small>
      </footer>
    </main>
  );
    }
