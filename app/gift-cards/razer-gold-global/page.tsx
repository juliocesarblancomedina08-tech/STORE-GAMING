...
const offers: GiftCardOffer[] = [
  ...
  { id: 9, amount: "200 USD", price: 187.55 },
  { id: 10, amount: "300 USD", price: 281.24 },
  { id: 11, amount: "400 USD", price: 378.69 },
  { id: 12, amount: "500 USD", price: 468.64 },
];

const note =
  "Región: CN / Otros / EE. UU. / VN. Tarjetas de regalo Razer Gold (PIN global). Los códigos se pueden guardar de forma segura y canjear posteriormente.";

export default function RazerGoldGlobal() {
  ...
  return (
    <main className="game-service-page">
      ...
      <section className="game-service-content">
        <img
          src="/images/gift-cards/gift-razer-gold-global.jpg"
          alt="Razer Gold Global"
