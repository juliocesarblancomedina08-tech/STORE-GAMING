...
const offers: GiftCardOffer[] = [
  {
    id: "google-play-eeuu-5",
    amount: 5,
    price: 5.1,
  },
  {
    id: "google-play-eeuu-10",
    amount: 10,
    price: 10.05,
  },
  {
    id: "google-play-eeuu-15",
    amount: 15,
    price: 15.01,
  },
  {
    id: "google-play-eeuu-20",
    amount: 20,
    price: 19.96,
  },
  {
    id: "google-play-eeuu-25",
    amount: 25,
    price: 24.91,
  },
  {
    id: "google-play-eeuu-50",
    amount: 50,
    price: 49.68,
  },
  {
    id: "google-play-eeuu-75",
    amount: 75,
    price: 74.44,
  },
  {
    id: "google-play-eeuu-100",
    amount: 100,
    price: 99.2,
  },
  {
    id: "google-play-eeuu-150",
    amount: 150,
    price: 148.73,
  },
  {
    id: "google-play-eeuu-200",
    amount: 200,
    price: 198.25,
  },
];
...
const note =
  "Región: EE. UU. Tarjetas de regalo de Google Play. Los códigos se pueden guardar de forma segura y canjear posteriormente.";

export default function GooglePlayEEUUGiftCardPage() {
    ...
    <main className="game-service-page">
      ...
      <section className="game-service-content">
        ...
        <div className="free-fire-main-image">
          <img
            src="/images/gift-cards/gift-google-play-eeuu.jpg"
            alt="Google Play EE.UU"
          />
        </div>
      ...
      <footer className="game-service-footer">
        ...
        <span>
          Tarjetas de regalo Google Play EE.UU
        </span>
      </footer>
    </main>
  );
